function startgame()
{
 ...
 $('.chatlog').append('<span>' + monstername + ' dateng </span>');
      ...
      (
       function()
        { 
         ...
         $('.chatlog').append('<span> Kamu berdarah ' + randomattack[1] + ' points </span>');
  ...
  ("click", function()
   {
    ...
    if (type == "poison")
	   {
	    ...
	    $('.chatlog').append('<span> Jurus ' + playerattackname + ' kena ' + monstername + '</span>');
	    $('.playereffect').append
		 ('<img src = "data/rpg/images/effects/' + playeractions[0] + '.png" style = "width:60%" class = "playerimgfx">');
	     ...
	     function()
	      {
		   ...
		   $('.monsterhealth').css('width', newwidth);
		   $('.chatlog').append('<span>' + monstername + ' berdarah ' + playeractions[1] + ' points </span>');
    ...
    if (type == "magic")
       {	
	    var playerattackname = playeractions[0].replace("-", " ");
	    $('.chatlog').append('<span>Jurus ' + playerattackname + ' on ' + monstername + '</span>');
    ...
    if (type == "heal")
       {
        var playerattackname = playeractions[0].replace("-", " ");
	    $('.chatlog').append('<span> Jurus ' + playerattackname + '</span>');
	    $('.playereffect').append('<img src = "data/rpg/images/effects/' + playeractions[0] + '.png" class = "playerimgfx">');
	    ...
	    (
	     function()
	      {
		   $('.chatlog').append('<span> Heal ' + amountheal + ' points </span>');
		   $('.playereffect').empty('<img src = "data/rpg/images/effects/' + playeractions[0] + '.png">');
	      },
	      950
	    ); 
  ...
  function(pois)
   {
    ...
    $('.monsterlife').html('' + monsterhp + '/' + originalmonsterhp + '');
    $('.monsterhealth').css('width', newwidth);
    $('.chatlog').append('<span>' + monstername + ' kena racun ' + poisondamage + ' points</span>');
   },
   poisontick
 );
}
