	    ...
	    (
		 {
		  ...
		  focus: function(h, g)
		   {
			return typeof h === "number" ? this.each
			 (
			  function()
			   {
				var i = this;
		  ...
		  scrollParent: function()
		   {
		    var h;
		    h = a.browser.msie && /(static|relative)/.test(this.css("position")) ||
		  ...
		  disableSelection: function()
		   {
			return this.bind
			 (
			  ...
			  ".ui-disableSelection", function(h){h.preventDefault()}
			 )
		   },
		   ...
		   a.fn["inner" + g] = function(l)
								{
								 ...
								 return this.each(function(){a(this).css(f, i(this, l) + "px")})
								};
		   a.fn["outer" + g] = function(l, o)
								{
								 if (typeof l !== "number")
									return j["outer" + g].call(this, l);
								 return this.each(function(){a(this).css(f, i(this, l, true, o) + "px")})
								}
		  }
		);
	   a.extend
		   ...
		   function(h, g)
		    {
			 return document.compareDocumentPosition ?
			        h.compareDocumentPosition(g) & 16 :
					 h !== g && h.contains(g)
			},
		  hasScroll:
		   function(h, g)
    ...
    function(h, g, i)
     {
	  ...
	  a.expr[":"][f] = function(j){return !!a.data(j, h)}; //!! = not not ?
	  a[b] = a[b] || {};
	  ...
	  function(h, g)
	   {
		this.options[h] = g;
		if (h === "disabled")
		   this.widget()[g ? "addClass" : "removeClass"](this.widgetBaseClass + "-disabled ui-state-disabled").
   ...
   a.widget
    (
	 "ui.mouse",
	 {
	   ...
	   function()
	    {
		 ...
		 this.element.bind
		  (
		   ...
		   function(e) {return c._mouseDown(e)}
		  ).bind
		  (
	  ...
	  _mouseDestroy:
	   function( ) {this.element.unbind("." + this.widgetName)},
	  _mouseDown:
	   function(c)
	    {
		 if (!d)
			{
			 ...
			 var e = this,
			 h = c.which == 1,
			 g = typeof this.options.cancel == "string" && c.target.nodeName ?
				 a(c.target).closest(this.options.cancel).length : false;
			 ...
			 a(document).bind("mousemove." + this.widgetName, this._mouseMoveDelegate).
	   ...
	   function(c)
	    {
		 ...
		 if (this._mouseDistanceMet(c) && this._mouseDelayMet(c))
			(this._mouseStarted = this._mouseStart(this._mouseDownEvent, c) !== false) ?
			 this._mouseDrag(c) : this._mouseUp(c);
	  ...
	  _mouseDistanceMet:
	   function(c)
	    {
		 return
		  Math.max(Math.abs(this._mouseDownEvent.pageX - c.pageX), Math.abs(this._mouseDownEvent.pageY - c.pageY)) >=
